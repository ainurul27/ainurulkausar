 ...
 * @author Labkom M21
 */
public class ainurulkausar extends javax.swing.JFrame {

    /**
     * Creates new form ainurulkausar
     */
    public ainurulkausar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ainurulkausar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ainurulkausar().setVisible(true);
            }
        });
    }
